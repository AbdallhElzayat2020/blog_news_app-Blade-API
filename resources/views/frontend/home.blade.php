                ...
                <div class="col-md-6 tn-left">
                    <div class="row tn-slider">
                        @foreach ($latest_posts as $post)
                            <div class="col-md-6">
                                <div class="tn-img">
                                    <img style="width: 510px; height: 383px" src="{{ asset($post->images->first()->path) }}"
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <ul class="nav nav-pills nav-justified">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="pill" href="#m-read">Latest News</a>
                        </li>
                    </ul>
                                ...
                                <div class="tn-news">
                                    ...
                                    <div class="tn-title">
                                        <a href="{{ route('frontend.post.show',$post->slug) }}" title="{{ $post->title }}">
                                            {{ $post->title }} <i class="far fa-eye"></i> ({{ $post->number_of_views }})
                                        </a>
                                    </div>
                                </div>
                            @endforeach
